...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(Routes.AboutScreenRoute.name) { AboutScreen(navHostController = navController) }
        composable(Routes.ScoreScreenRoute.name) { ScoreScreen(navHostController = navController) }
